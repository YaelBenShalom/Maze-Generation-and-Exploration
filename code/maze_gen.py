...
class Maze:
    ...
    # iterating through the frontier_list
        while self.frontier_list:
            ...
            frontier_neighbor = self.choose_neighbor(
                random_frontier[0], random_frontier[1], 0)
            ...
            self.init_matrix[self.middle_cell(random_frontier, frontier_neighbor)[
                0]][self.middle_cell(random_frontier, frontier_neighbor)[1]] = 0
            add_to_frontier_list = self.choose_neighbor(
                random_frontier[0], random_frontier[1], 1)
    ...
    def middle_cell(self, first_array, second_array):
        ...
        middle_array = [int((first_array[0] + second_array[0])/2),
                        int((first_array[1] + second_array[1])/2)]
        return middle_array
